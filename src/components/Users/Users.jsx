            ...
            </div>
            {
                props.users.map(u => <div key={u.id} >
                    <span>
                        ...
                        <div>
                            {u.followed
                                ? <button className={style.followButton} onClick={() => { props.unfollow(u.id) }}>unfollow</button>
                                : <button className={style.followButton} onClick={() => { props.follow(u.id) }}>follow</button>}
                        </div>
                    </span>
                    <span>
                        <span>
